...
<html lang="it">
  <head>
    ...
    <?php
      include './connect.php';
      $cod = $_GET['codice'];
      $sql = "select * from Quiz where cod_malore={$cod} order by RAND() limit 5";
    ...
    <div class="container-fluid sfondoGrigioQuiz" id="spazioNavbarContainer">
        <div class="row">
            <div class="col-md-4 offset-md-4 mb-3 col-10 offset-1" id="title-quiz">
                ...
                <h2 class="pt-1 px-2"><?php foreach($query2 as $q2){echo $q2['nome'];} ?></h2>
            </div>
            ...
            <div class="col-md-4 offset-md-4 mb-3 col-10 offset-1 d-grid pb-4 " id="div_invia">
                <input type="button" id="risolvi_quiz" value="Invia" onclick="soluzioneQuiz()" >
            </div>
